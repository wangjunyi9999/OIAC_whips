...
from mpi_pytorch import mpi_avg_grads
from mpi_tools import mpi_avg
...
class ContinuousActor(nn.Module):
	...
	def forward(self, state, action=None):
        ...
        #TODO： CANNOT add a coefficent 0.1 , Need clipping or clamp, so noise clamp now.
		#std= 0.6065
		pi = mu + noise * std 
		#print("pi:",pi, "noise",noise)
