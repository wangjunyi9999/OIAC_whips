...
class System:
	...
	def dynamic_oiac(self, pos_1, pos_2, pos_1_desire, pos_2_desire, vel_1_desire, vel_2_desire, vel_1, vel_2, is_oiac):
		...
		if is_oiac:
			...
			torque_1=  K*(pos_1_desire- pos_1)+ B*(vel_1_desire - vel_1)
			torque_2=  K*(pos_2_desire- pos_2)+ B*(vel_2_desire - vel_2)
	...
	def step_action(self, action):
		...
		while(sum_step<=action[4]):
			...
			torque_1, torque_2= self.dynamic_oiac(action, pos_1_desire, pos_2_desire,
											vel_1_desire, vel_2_desire,vel_1, vel_2, is_oiac=True)
