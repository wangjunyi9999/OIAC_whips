...
class Simulation:
    ...
    def __init__( self, args ):
        ...
        self.q1_start_valueset= np.linspace(self.q1_ini_min, self.q1_ini_max, self.scale)
        self.q1_end_valueset= np.linspace(self.q1_end_min, self.q1_end_max ,self.scale)
