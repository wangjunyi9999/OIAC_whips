...
def my_parser( ):
    ...
    parser.add_argument( '--print_freq'  , action = 'store'       , type = int   ,  default = 20      ,              help = 'Specifying the frequency of printing the data.'                                    )
    ...
    parser.add_argument("--start_timesteps", default=1200, type=int, help="Time steps initial random policy is used")    #25e3
    parser.add_argument("--max_timesteps", default=1e6, type=int, help="Max time steps to run environment")   #  1e6
    ...
    parser.add_argument("--reward_scale", default=20, type=int, help="From 1 to 100 normally") 
