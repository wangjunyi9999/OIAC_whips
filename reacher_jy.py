...
class ReacherEnv_jy(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    """
#step time 0.001 render fps= 500
    metadata = {
        "render_modes": [
            "human",
            "rgb_array",
    ...
    def __init__(self, **kwargs):
        ...
        """
        change
            1: observation space 11 -> 1: dist
            2: action space 2 -> 5 q1_i; q1_e; q2_i; q2_e; D
        """
        observation_space = Box(low=np.array([0]), 
                        high=np.array([4]), 
                        shape=(1,), dtype=np.float64)
        MujocoEnv.__init__(
            self, "reacher_jy.xml", 2, observation_space=observation_space, **kwargs
        )
    ...
    def _get_obs(self):
        ...
        1: torque_0
        2: torque_1
        3,4,5: fingertip2ball vec [x,y,z] 
